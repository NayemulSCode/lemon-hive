  ...
  return (
    <section className="flex md:flex-row flex-col md:gap-5 gap-0 md:mt-40 mt-32 md:p-10 xl:px-64 p-4">
      <div className="left-hero flex-[2] relative">
        <Image
          src={rcon}
          className="md:block hidden absolute xl:scale-120 md:scale-125 top-0 right-0 md:-top-24 md:-right-72 bottom-32 -z-10"
        ...
        <div className="innerdiv flex gap-8 sm:mt-28 mt-[80px] xl:mt-72">
          ...
          <div className="">
            ...
            <p className="mb-4 pr-2 md:hidden block mt-16">
              Lorem ipsum dolor sit amet, held consectetur adipisicing elit.
              Hello this is testing Lorem ipsum dolor sit amet, consectetur
            ...
            <button
              type="button"
              className="mt-8 flex gap-2 mx-auto items-center lg:px-10 px-6 lg:py-2 py-3 font-semibold rounded-full bg-yellow text-black"
            >
